...
export default function ItemDetailContainer() {
    ...
    let { detalleId } = useParams();
        ...
        const productos = [
            { id: 1, stock: 21, title: "REMERA KID DINOS", description:"Remera de jersey de algodón , manga corta, con estampa en el delantero", category: "Remeras", price: 1990, pictureUrl:"https://mimoar.vtexassets.com/arquivos/ids/10585229-1200-auto?v=637880588851400000&width=1200&height=auto&aspect=true" },
            ...
            {id: 4 , stock: 7, title:"REMERA JR BAHAMAS", description:"Remera de jersey flame con detalle de Estampa 'less is more'", category: "Remeras", price: 1190 , pictureUrl:"https://mimoar.vtexassets.com/arquivos/ids/10713197-1200-auto?v=637892152431930000&width=1200&height=auto&aspect=true"},
            ...
            {id: 6, stock: 15, title:"REMERA KID POSITIVE", description:"Remera de jersey, con estampa plana", category: 'Remeras', price: 1790, pictureUrl:"https://mimoar.vtexassets.com/arquivos/ids/10936359-1200-auto?v=637909833519570000&width=1200&height=auto&aspect=true"},
